...
namespace Hybridview.Rest {
    ...
    public partial class DataContext : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(string name, string lastname, string username, string email, string password, System.DateTime date_created, System.DateTime date_modified) {
            ...
            private void InitClass() {
                ...
                this.columnemail.MaxLength = 199;
...
namespace Hybridview.Rest.DataContextTableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [users] ([name], [lastname], [username], [email], [password], [date_c" +
                "reated], [date_modified]) VALUES (@name, @lastname, @username, @email, @password" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [users] SET [name] = @name, [lastname] = @lastname, [username] = @username" +
                ", [email] = @email, [password] = @password, [date_created] = @date_created, [dat" +
                "e_modified] = @date_modified WHERE (([id] = @Original_id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["HybridViewConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, name, lastname, username, email, password, date_created, date_m" +
                "odified\r\nFROM            users";
        ...
        public virtual int Fill(DataContext.usersDataTable dataTable) {
        ...
        public virtual DataContext.usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataContext.usersDataTable dataTable = new DataContext.usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataContext.usersDataTable dataTable) {
        ...
        public virtual int Insert(string name, string lastname, string username, string email, string password, System.DateTime date_created, System.DateTime date_modified) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string lastname, string username, string email, string password, System.DateTime date_created, System.DateTime date_modified, int Original_id) {
            if ((name == null)) {
